...
from .views import product_list, product_detail, add_to_cart, cart_view, remove_from_cart, increase_quantity, decrease_quantity,wishlist,add_to_wishlist,remove_from_wishlist
